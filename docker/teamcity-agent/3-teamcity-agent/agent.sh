...
agent_token=$TEAM_CITY_INSTALL_DIR/TeamCity/buildAgent/conf/persist/agentId
...
# TODO: What copies the auth token into the agent_token file in the first place?
[ -r "$agent_token" ] && auth_token=$(cat "$agent_id") || auth_token=
